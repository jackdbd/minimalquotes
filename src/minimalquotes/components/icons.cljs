...
(defn icon-cross
  ...
  [{:keys [css-classes data-attributes]
    :or {css-classes default-css-classes}}]
  [icon {:css-classes css-classes
         :data-attributes data-attributes
         :d "M14.348,14.849c-0.469,0.469-1.229,0.469-1.697,0L10,11.819l-2.651,
...
(defn icon-edit
  ...
  [icon {:css-classes css-classes
         :data-attributes data-attributes
         :d "M17.561 2.439c-1.442-1.443-2.525-1.227-2.525-1.227L8.984
...
(defn icon-like
  ...
  [icon {:css-classes css-classes
         :data-attributes data-attributes
         :d "M17.19 4.155c-1.672-1.534-4.383-1.534-6.055 0L10 5.197
...
(defn icon-share
  ...
  [icon {:css-classes css-classes
         :data-attributes data-attributes
         :d "M15 13.442c-.633 0-1.204.246-1.637.642l-5.938-3.463c.046-.188.075-.384.075-.584s-.029-.395-.075-.583L13.3
...
(defn icon-signal
  ...
  [icon {:css-classes css-classes
         :data-attributes data-attributes
         :d "M10 14a1.99 1.99 0 0 0-1.981 2c0 1.104.887 2 1.981 2a1.99 1.99 0 0 0 1.98-2c0-1.105-.886-2-1.98-2zm-4.2-2.242l1.4 1.414a3.933 3.933 0 0 1 5.601 0l1.399-1.414a5.898 5.898 0 0 0-8.4 0zM3 8.928l1.4 1.414a7.864 7.864 0 0 1 11.199 0L17 8.928a9.831 9.831 0 0 0-14 0zM.199 6.1l1.4 1.414a11.797 11.797 0 0 1 16.801 0L19.8 6.1a13.763 13.763 0 0 0-19.601 0z"}])
...
(defn icon-trash
  ...
  [icon {:css-classes css-classes
         :data-attributes data-attributes
         :d "M3.389,7.113L4.49,18.021C4.551,18.482,6.777,19.998,10,
