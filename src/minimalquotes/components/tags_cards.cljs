...
(defcard tag-card (dc/reagent [tag fakes/tag-love]))

(defcard "## Tags")

(defn on-click-tag [tag-name] (js/alert (str "click tag: " tag-name)))
...
;;         tr (render (r/as-element [tags props]) #js {:container
;;         (testing-container)})
