...
(def tag-art {:color "indigo" :description "A tag about art" :name "art"})
(def tag-cool
  {:color "purple" :description "A tag about cool stuff" :name "cool"})
(def tag-friendship
  {:color "yellow" :description "A tag about friendship" :name "friendship"})
(def tag-love {:color "red" :description "A tag about love" :name "love"})
(def tag-money
  {:color "green" :description "A tag about money" :name "money"})
(def tag-motivation
  {:color "pink" :description "A tag about motivation" :name "motivation"})
(def tag-skill {:color "teal" :description "A tag about skill" :name "skill"})
(def tag-style {:color "gray" :description "A tag about style" :name "style"})
(def tag-wisdom
  {:color "orange" :description "A tag about wisdom" :name "wisdom"})
...
(def quote-0 {:author author-0 :tags tags :text text-0})
...
(def quotes
  {quote-id-0 quote-0
   ...
   {:author "Nicolò Machiavelli"
    ...
    :text
    "Both fortune and virtue are needed to become a prince. Without virtue, no fortune can last; without fortune, your virtues may be useless."}
   quote-id-3
   {:author "Zen master"
